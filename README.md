# AI 实战手册 — Cursor / OpenAI Codex / ChatGPT / OpenAI API 中文实战教程

[![在线阅读](https://img.shields.io/badge/在线阅读-www.aixiaobai168.com-0ea5e9?style=for-the-badge)](https://www.aixiaobai168.com)
[![GitHub stars](https://img.shields.io/github/stars/wybzsngw/ai-playbook?style=for-the-badge&label=stars&color=orange)](https://github.com/wybzsngw/ai-playbook/stargazers)
...
当前有效教程以仓库中的 Markdown 文件为准，`src/` 下的 Astro 站点在构建时读取这些 Markdown 生成 [aixiaobai168.com](https://www.aixiaobai168.com) 上的页面，不需要维护第二份内容。`docs/` 是旧版纯 HTML 静态站的历史文件（2026 年之前的路由器/VPN 主题内容，已长期暂停维护），已整体归档到 [`legacy-site`](https://github.com/wybzsngw/ai-playbook/tree/legacy-site) 分支保留查阅，主分支不再提供，也不会恢复。
...
- 仓库将改名为 `ai-playbook`（原名 `router-vpn`，GitHub 已自动为旧地址建立跳转，历史 star/fork/Issue/PR 不受影响）。
...
- 文档问题请提交 [Issue](https://github.com/wybzsngw/ai-playbook/issues)。
- 欢迎提交 Pull Request。
